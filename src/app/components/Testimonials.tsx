...
export const Testimonials = () => {
  ...
  const goToPrevioustestimonial = () => {
    ...
    const element = document.getElementById("testimonialSection");
    ...
    <>
        ...
        {testimonials.map((testimonial) => (
          ...
          >
            <div className="flex items-center gap-24px">
              <img src={`/png/${testimonial.img}.png`} alt={testimonial.img} />
              <div>
      ...
      <div className="flex items-end justify-between px-26px mt-24px">
        ...
        <div className="flex gap-10px">
          <button
            className="border border-violet-50 bg-white-100 rounded-3xl h-40px w-40px"
